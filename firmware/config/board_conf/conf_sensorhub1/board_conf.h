...
#define BOARD_CONF_SENSOR1_INIT(sensor_ctx) vl53l4cd_init_sensor(sensor_ctx)
#define BOARD_CONF_SENSOR1_SAMPLE(sensor_ctx, read_buf) \
    vl53l4cd_read_sensor(sensor_ctx, read_buf)
#define BOARD_CONF_SENSOR1_DEINIT(sensor_ctx) vl53l4cd_deinit_sensor(sensor_ctx)
#define BOARD_CONF_SENSOR1_SAMPLE_T vl53l4cd_sample_data_t
#define BOARD_CONF_SENSOR1_SAMPLE_PARSE(read_buf, sample_data) vl53l4cd_parse_raw_data(read_buf, sample_data)
