 ...
 * @param i2c_inst Platform specific typedef ptr to your memory mapped i2c
 * peripheral (e.g. handle)
...
/**
 * @brief Reset the I2C peripheral and sensor by toggling the physical voltage
 * line of sensor
 * @param i2c_inst I2C instance
 * @return Integer value 0 on success, 1 on fail
 */
